...
+ a typical approach is to treat an n-label classification problem as a set of n binary classification problems
+ algorithms used to solve this kind of problem also include:
  - Naive Bayes
